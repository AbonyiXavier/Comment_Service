...
export const getCommentsByUserId = async (userId, page, limit) => {
  try {
    ...
    return await constructFetchCommentsByUserIdEntity(
      userId,
      limit,
      page,
      totalPages,
 ...
 * @returns
 */
async function constructFetchCommentsByUserIdEntity(
  userId,
  limit,
  page,
  totalPages,
...
export const getCommentsPaginatedAndSearch = async (search, page, limit) => {
  try {
    ...
    return await constructFetchCommentsEntity(
      query,
      limit,
      page,
      totalPages,
 ...
 * @returns
 */
async function constructFetchCommentsEntity(
  query,
  limit,
  page,
  totalPages,
